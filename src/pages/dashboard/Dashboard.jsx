...
import { PERMISSIONS, ROLE_META } from "../../config/permissions";
      ...
      {canViewFullDashboard ? (
          ...
          <div className='db-grid-2' style={{ marginTop: "1.5rem" }}>
            ...
            <div className='db-card'>
              <div className='db-card-header'>
                ...
                <span
                  className='db-badge'
                  style={{ background: rateColor + "22", color: rateColor }}
                >
                  {collectionRate}%
                </span>
              </div>
          ...
          <div className='db-grid-2' style={{ marginTop: "1.25rem" }}>
            ...
            <div className='db-card'>
              ...
              {stats.classBreakdown.length ? (
                ...
                <p
                  style={{ color: "var(--color-text-tertiary)", fontSize: 13, margin: "1.5rem 0" }}
                >
        ...
        <div className='db-card' style={{ marginTop: "1.5rem" }}>
          ...
          <p style={{ color: "var(--color-text-secondary)", marginBottom: "1rem" }}>
            Your role can access operational pages. Financial analytics are limited for this
            account.
          </p>
          ...
          <div style={{ marginTop: "1rem", display: "flex", gap: "0.75rem", flexWrap: "wrap" }}>
            {can(PERMISSIONS.VIEW_STUDENTS) && (
              <button className='view-all-btn' onClick={() => navigate("/students")}>
                Go to Students <HiArrowRight />
              </button>
            )}
            {can(PERMISSIONS.VIEW_FAMILIES) && (
              <button className='view-all-btn' onClick={() => navigate("/families")}>
                Go to Families <HiArrowRight />
              </button>
            )}
          </div>
        </div>
